...
// #include "egmri_controller_pkg/rostopicsensor.h"

using namespace egmri_control;

// Factory function.
Sensor* Sensor::create_sensor(SensorType type, ros::NodeHandle& n, RobotPlugin *plugin, egmri::ActuatorType actuator_type)
{
    switch (type)
    {
